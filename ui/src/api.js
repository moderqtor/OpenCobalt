...
export const api = {
  ...
  canonicalizeRepository: (input = {}) => request("/repositories/canonicalize", jsonOptions("POST", input)).then((value) => recordOf(value, "repository path")),
  ...
  changeset: (changesetId, inspect = false) => request(`/changesets/${encodeURIComponent(changesetId)}${inspect ? "?inspect=true" : ""}`).then((value) => recordOf(value, "changeset")),
  changesetDiff: (changesetId) => request(`/changesets/${encodeURIComponent(changesetId)}/diff`).then((value) => recordOf(value, "changeset diff")),
  applyChangeset: (changesetId, reason = "") => request(`/changesets/${encodeURIComponent(changesetId)}/apply`, jsonOptions("POST", { reason })).then((value) => recordOf(value, "changeset")),
  rejectChangeset: (changesetId, reason = "") => request(`/changesets/${encodeURIComponent(changesetId)}/reject`, jsonOptions("POST", { reason })).then((value) => recordOf(value, "changeset")),
